                  ...
                  <div class="outer-flexbox">
                        <div class="column inner-flexbox-left">
                              <p class="text item item-1">
                                    ...
                                    einzigartige Möglichkeit, die Form und
                                    Funktion von Satelliten durch hands-on
                                    Erfahrung zu erlernen. Jedes Modell enthält
                                    Bauteile, die vereinfacht realen
...
img {
      ...
      /* maybe variable erstellen*/
      max-width: 600px;
      /* irwie steuer ich gerade die größe vom Farbcontainer damit*/
